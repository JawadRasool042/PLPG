...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-950 dark:to-indigo-950 overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-5xl md:text-6xl lg:text-7xl animate-slide-up">
                Personalized Learning
                <span className="block bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-2">
                  Made Simple
                </span>
              </h1>
              <p className="mt-6 text-lg sm:text-xl leading-8 text-gray-600 dark:text-slate-300 max-w-2xl mx-auto lg:mx-0 animate-slide-up animation-delay-200">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-slide-up animation-delay-400">
                {!isAuthenticated ? (
                  <>
                    ...
                    <Link
                      to="/login"
                      className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-gray-800 dark:text-slate-100 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border border-gray-200 dark:border-slate-700 rounded-xl shadow-lg hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                      Login
                    </Link>
                  </>
            ...
            <div className="relative lg:block animate-fade-in animation-delay-800">
              <div className="relative group cursor-pointer">
                ...
                />
                {/* Floating Cards */}
                <div className="absolute -bottom-6 -left-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/50 dark:border-slate-700 p-4 rounded-2xl shadow-2xl animate-float hover:scale-105 transition-all duration-300 cursor-pointer">
                ...
                <div className="absolute -top-6 -right-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/50 dark:border-slate-700 p-4 rounded-2xl shadow-2xl animate-float animation-delay-2000 hover:scale-105 transition-all duration-300 cursor-pointer">
                  <div className="flex items-center gap-3">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 sm:py-28 bg-slate-50 dark:bg-slate-900 relative transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature Card 1 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-500 transform transition-all duration-300 hover:-translate-y-2 cursor-pointer">
            ...
            {/* Feature Card 2 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-purple-200 dark:hover:border-purple-500 transform transition-all duration-300 hover:-translate-y-2 cursor-pointer">
            ...
            {/* Feature Card 3 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-500 transform hover:-translate-y-2 transition-all duration-300">
            ...
            {/* Feature Card 4 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-green-200 dark:hover:border-green-500 transform hover:-translate-y-2 transition-all duration-300">
            ...
            {/* Feature Card 5 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-orange-200 dark:hover:border-orange-500 transform hover:-translate-y-2 transition-all duration-300">
            ...
            {/* Feature Card 6 */}
            <div className="group bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-slate-700 hover:border-teal-200 dark:hover:border-teal-500 transform hover:-translate-y-2 transition-all duration-300">
      ...
      {/* About PLPG Section */}
      <section id="about" className="relative py-20 sm:py-28 bg-white dark:bg-slate-950 overflow-hidden transition-colors duration-300">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="order-1 lg:order-2 space-y-8">
              <div className="bg-gradient-to-br from-indigo-50 to-white dark:from-slate-800 dark:to-slate-900 p-8 rounded-2xl border border-indigo-100 dark:border-slate-700">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-white dark:from-slate-800 dark:to-slate-900 p-8 rounded-2xl border border-purple-100 dark:border-slate-700">
