...
const LearningPath: React.FC = () => {
  ...
  if (!hasPrimaryInterest) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-950 dark:to-indigo-950 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="text-6xl mb-4">🎯</div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">No Learning Path Yet</h2>
          <p className="text-slate-600 dark:text-slate-300 mb-6">Complete the Interest Assessment first to get your personalized learning path.</p>
          <button
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-950 dark:to-indigo-950 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-slate-600 dark:text-slate-300">Checking your quiz progress…</p>
        </div>
      </div>
    );
  }
  ...
  if (remediationGate?.activeLock) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-amber-50 dark:from-slate-950 dark:to-amber-950 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center max-w-lg mx-auto px-4">
          <div className="text-6xl mb-4">📚</div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Complete remediation before continuing</h2>
  ...
  if (!quizUnlocked) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 dark:from-slate-950 dark:to-indigo-950 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center max-w-lg mx-auto px-4">
          <div className="text-6xl mb-4">📝</div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Take a quiz to unlock your path</h2>
          <p className="text-slate-600 dark:text-slate-300 mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-white dark:bg-slate-900 text-indigo-700 border border-indigo-200 rounded-xl font-semibold hover:bg-indigo-50 dark:hover:bg-indigo-900/40 transition-colors"
            >
              Quiz hub
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-white to-indigo-50/80 pt-20 pb-10 sm:pt-24 sm:pb-12">
      <div className="mx-auto w-full min-w-0 px-4 sm:px-6 lg:px-10 xl:px-14 2xl:px-16">
        ...
        {roadmapLoading && (
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4 mb-6 text-sm text-slate-600 dark:text-slate-300">
        ...
        {!!roadmapFromApi?.next_step && (
          <div className="mb-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-5">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Why this next step</p>
            <h3 className="mt-1 text-lg font-bold text-slate-900 dark:text-white">
              {(roadmapFromApi.next_step as { type?: string }).type}: {(roadmapFromApi.next_step as { title?: string }).title}
            </h3>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">{(roadmapFromApi.next_step as { why?: string }).why}</p>
        ...
        <div className="-mx-1 mb-6 flex gap-1 overflow-x-auto overscroll-x-contain rounded-xl border border-violet-200/70 bg-gradient-to-r from-violet-50/90 via-indigo-50/80 to-violet-50/90 p-1 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] sm:mx-0 sm:flex-wrap sm:overflow-visible">
          {tabList.map((tab) => (
            <button
              key={tab}
              ...
              className={cn(
                ...
                activeTab === tab
                  ...
                  : 'border border-violet-100/90 bg-white dark:bg-slate-900/75 text-slate-700 dark:text-slate-300 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] hover:border-violet-200 hover:bg-violet-100/80 hover:text-violet-950',
              )}
            >
              {tab === 'roadmap'
                ? '🗺️ Roadmap'
        ...
        {activeTab === 'roadmap' && (
          <div className="w-full space-y-6 sm:space-y-8">
            <header className="border-b border-slate-200 dark:border-slate-700/90 pb-6">
              <div className="min-w-0 space-y-2">
                ...
                <h2 className="text-balance font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-3xl xl:text-4xl">
                  Road map
                </h2>
            ...
            <div className="grid w-full min-w-0 items-start gap-6 lg:grid-cols-[minmax(260px,340px)_minmax(0,1fr)] lg:gap-8 xl:grid-cols-[minmax(280px,380px)_minmax(0,1fr)] xl:gap-10">
              <aside className="flex min-w-0 flex-col gap-5 lg:sticky lg:top-24 lg:self-start">
                <div className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700/90 bg-white dark:bg-slate-900/90 p-4 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] ring-1 ring-slate-900/[0.04] backdrop-blur-md sm:p-5">
                  <div
                  ...
                  <div
                    ...
                    aria-hidden
                  />
                  <p className="relative text-sm leading-relaxed text-slate-700 dark:text-slate-300 sm:text-[0.9375rem]">
                    <span className="font-semibold text-slate-900 dark:text-white">{primary}</span>
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-slate-700/90 bg-white dark:bg-slate-900/90 p-4 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] sm:p-5">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                    <span className="shrink-0 text-xs font-medium tabular-nums text-slate-600 dark:text-slate-300 sm:text-sm">
                      Path progress{' '}
                      <span className="font-semibold text-slate-900 dark:text-white">{Math.round(progression * 100)}%</span>
                    </span>
                    <div className="h-2 min-h-[8px] w-full flex-1 overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700/90 shadow-inner sm:min-w-0">
                      <div
                  ...
                  <li key={i} className="list-none">
                    <article
                      className={cn(
                        ...
                        'group/card relative flex gap-3 overflow-hidden rounded-2xl border bg-white dark:bg-slate-900/90 p-4 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] backdrop-blur-sm transition-all duration-300 sm:gap-5 sm:p-6',
                        ...
                        isDone && 'border-slate-200 dark:border-slate-700/90',
                        !isCurrent && !isDone && 'border-slate-200 dark:border-slate-700/70 hover:opacity-100 sm:opacity-90',
                      )}
                    ...
                    >
                      ...
                      <div className="relative min-w-0 flex-1 pb-0.5">
                        <div className="mb-3 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                          <h3 className="text-lg font-bold tracking-tight text-slate-900 dark:text-white sm:text-xl">{phase.phase}</h3>
                          {isCurrent && (
                        ...
                        <p className="mb-5 flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300">
                        ...
                        <div className="mb-1 flex items-center gap-2">
                          ...
                          <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-slate-600 dark:text-slate-300 sm:text-xs">
                            Topics
                          </p>
                        </div>
                        ...
                        {phase.projects.length > 0 && (
                          <>
                            ...
                            <ul className="mb-5 list-disc space-y-1 pl-4 text-xs text-slate-600 dark:text-slate-300">
                        ...
                        {phase.milestones.length > 0 && (
                          <>
                            ...
                            <ul className="mb-1 list-disc space-y-1 pl-4 text-xs text-slate-600 dark:text-slate-300">
            ...
            <div className="flex justify-center border-t border-slate-200 dark:border-slate-700/80 pt-6 sm:pt-8">
              <button
                type="button"
                onClick={() =>
                  navigate('/ai-quiz', {
        ...
        {activeTab === 'courses' && (
          <div className="space-y-5">
            {!!renderedCourses.length && (
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-5">
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
                  {renderedCourses.map((course, i) => (
                    <div
                      key={`${course.name}-${i}`}
                      className="rounded-xl border border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-900 hover:border-indigo-300 hover:shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] transition-all"
                    >
                      <a
                        href={course.url}
                        target="_blank"
                      ...
                      >
                        ...
                        <h3 className="font-bold text-slate-900 dark:text-white mb-1 group-hover:text-indigo-600 transition-colors">{course.name}</h3>
                        ...
                        {course.pakistanRelevance && (
                          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">{course.pakistanRelevance}</p>
                        )}
                      </a>
            ...
            {!renderedCourses.length && !coursesByInterest.length && !roadmapLoading && (
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 text-slate-600 dark:text-slate-300 text-sm">
            ...
            {coursesByInterest.map((group, idx) => (
              <div key={`${group.domain}-${idx}`} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-5">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2 mb-3">
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">{group.domain}</h3>
                  <span className="text-xs text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-full w-fit">
                    Your rating: {getPercentage(group.score)}%
                  </span>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">Also rated in your interest check — AI-picked courses for this domain.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
                  {group.courses.map((course, i) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="rounded-xl border border-slate-200 dark:border-slate-700 p-4 hover:border-indigo-300 hover:shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.15)] transition-all group bg-white dark:bg-slate-900"
                    >
                      ...
                      <h4 className="font-bold text-slate-900 dark:text-white mb-1 group-hover:text-indigo-600 transition-colors">{course.name}</h4>
                      <p className="text-sm text-slate-500 dark:text-slate-400">{course.platform}</p>
                    </a>
                  ))}
                </div>
            ...
            {careerGlobalTags.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {careerGlobalTags.map((t) => (
                  <span key={t} className="text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700">
                    {t}
                  </span>
                ))}
              </div>
              ...
              return (
                <div key={level} className="space-y-3">
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="text-base font-bold text-slate-900 dark:text-white">{levelLabel} careers</h3>
                    {isUserLevel && (
                    ...
                    {level !== userCareerLevel && CAREER_LEVEL_ORDER[level] > (CAREER_LEVEL_ORDER[userCareerLevel] ?? 0) && (
                      <span className="rounded-full bg-slate-100 dark:bg-slate-800 px-2.5 py-0.5 text-[11px] font-medium text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                        Up next
                      </span>
                    )}
                  </div>
                    ...
                    {levelCareers.map((career, i) => (
                      <div
                        ...
                        className={cn(
                          ...
                          career.progressStatus === 'current' ? 'border-indigo-300 ring-1 ring-indigo-100' : 'border-slate-200 dark:border-slate-700',
                      ...
                      >
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div className="min-w-0">
                            <h4 className="font-bold text-slate-900 dark:text-white leading-snug">{career.title}</h4>
                            <p className="text-[11px] capitalize text-slate-500 dark:text-slate-400">{levelLabel}</p>
                          </div>
                        </div>
                        {career.progressNote && (
                        ...
                        {career.tags.length > 0 ? (
                          <div className="flex flex-wrap gap-2 mt-3">
                            {career.tags.map((tag) => (
                              <span
                                ...
                                className="text-xs bg-indigo-50 text-indigo-800 px-2.5 py-1 rounded-full border border-indigo-100 dark:border-indigo-500/30 font-medium"
                              >
                                {tag}
                              </span>
                            ))}
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Aligned role for your {levelLabel.toLowerCase()} stage.</p>
                        )}
                      </div>
                    ))}
                  </div>
        ...
        {activeTab === 'resume' && (
          <div className="space-y-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Live resume outline</p>
              <h3 className="mt-2 text-xl font-bold text-slate-900 dark:text-white">{resumeOutline?.headline || 'Profile-driven resume guidance'}</h3>
              {!!resumeOutline?.keywords?.length && (
                <div className="flex flex-wrap gap-2 mt-4">
                  {resumeOutline.keywords.map((kw) => (
                    <span key={kw} className="text-xs bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-2.5 py-1 rounded-full border border-slate-200 dark:border-slate-700">
                      {kw}
                    </span>
                  ))}
                </div>
              ...
              {!resumeOutline?.bullets?.length && (
                <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">Complete your assessment fields (known / want / goals) and reload — bullets are built from that context.</p>
              )}
            </div>
          </div>
        )}

        <div className="mt-8 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h3 className="font-bold text-slate-900 dark:text-white">Ready to test your knowledge?</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Take quizzes tailored to your {primary} interest</p>
          </div>
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-950 transition-colors"
            >
              Home
            </button>
            <button
