          ...
          <>
            ...
            {!token ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="password" className="block text-base sm:text-lg font-bold text-slate-900 mb-3">
                    New Password
                  </label>
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full px-4 py-4 pl-12 pr-12 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none text-slate-900 placeholder-slate-400 text-sm sm:text-base bg-white/70 backdrop-blur-sm hover:bg-white/90 focus:bg-white"
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-base sm:text-lg font-bold text-slate-900 mb-3">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <input
